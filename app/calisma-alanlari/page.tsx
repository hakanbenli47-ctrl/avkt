...
export default function PracticeAreasPage() {
  return (
    <main><SiteHeader overlay />
      <section className="subpage-hero"><Image src="/law-library.jpg" alt="Hukuk kütüphanesi" fill priority /><div /><p>Uzmanlıklar</p><h1>Hukuki ihtiyaçlar,<br /><em>bütüncül bir bakışla.</em></h1></section>
