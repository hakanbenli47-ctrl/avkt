...
export default function ActivitiesPage() {
  return (
    <main>
      <SiteHeader overlay />
      <section className="activities-hero"><Image src="/law-library.jpg" alt="Hukuk kütüphanesi" fill priority sizes="100vw" /><div className="activities-hero-shade" /><div className="activities-hero-copy"><p>Faaliyetlerimiz</p><h1>Hukuki ihtiyaca göre<br /><span>doğru çalışma biçimi.</span></h1><span>Her dosya, hizmet türü ile ilgili hukuk alanının birlikte değerlendirilmesini gerektirir.</span></div></section>
