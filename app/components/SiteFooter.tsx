  ...
  return (
    <footer className="main-footer">
      ...
      <div className="footer-main">
        ...
        <div className="footer-contact"><strong>İletişim bilgileri</strong><p className="footer-phone">{contact.phoneDisplay}<span className="contact-messengers" data-no-translate> (WhatsApp · Telegram)</span></p><a href={`mailto:${contact.email}`}>{contact.email}</a><a href={`mailto:${contact.secondaryEmail}`}>{contact.secondaryEmail}</a><address data-no-translate>Altındağ Mah. · Tonguç Cad. No: 26<br />Mehmet Zeki Balcı İş Merkezi · K: 5 D: 17<br />Muratpaşa · Antalya · Türkiye</address><Link href="/iletisim">Konumu ve iletişimi görüntüle <span aria-hidden="true">↗</span></Link></div>
      ...
      <div className="footer-bottom"><span className="footer-confidentiality"><b>Gizlilik</b><span>Paylaştığınız bilgiler mesleki sır kapsamında korunur.</span></span><span>advocatinturkiye · Tüm hakları saklıdır.</span><span>İçerikler genel bilgilendirme amaçlıdır.</span><Link href="/cerez-ve-gizlilik#mesleki-gizlilik">Gizlilik</Link><CookieSettingsButton /></div>
    </footer>
  );
}
