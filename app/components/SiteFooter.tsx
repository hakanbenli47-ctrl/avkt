  ...
  return (
    <footer className="main-footer">
      ...
      <div className="footer-main">
        ...
        <div className="footer-contact"><strong>İletişim bilgileri</strong><a href={contact.phoneHref}>{contact.phoneDisplay}</a><a href={`mailto:${contact.email}`}>{contact.email}</a><a href={`mailto:${contact.secondaryEmail}`}>{contact.secondaryEmail}</a><address>Altındağ Mah. · Tonguç Cad. No: 26<br />Mehmet Zeki Balcı İş Merkezi · K: 5 D: 17<br />Muratpaşa · Antalya · Türkiye</address><Link href="/iletisim">Konumu ve iletişimi görüntüle <span aria-hidden="true">↗</span></Link></div>
